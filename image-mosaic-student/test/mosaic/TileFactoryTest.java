...
//	public Timeout globalTimeout = Timeout.seconds(10); // 10 seconds
	...
	public void setup() throws InterruptedException
	{
		...
		redOnlyTileFactory = new TileFactory(new int[]
		{ RGB_RED }, WIDTH, HEIGHT);
	...
	public void testGetMultipleTiles()
	{
		...
		redOnlyTileFactory.printMap();

		BufferedImage var1 = ImageUtils.resize(redImages.get(0), WIDTH, HEIGHT);
		BufferedImage var2 = redOnlyTileFactory.getTile(hueRed);
